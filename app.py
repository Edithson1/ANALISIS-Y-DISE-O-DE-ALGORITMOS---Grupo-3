...
def show_authenticated_content():
    ...
    if archivo is not None:
        ...
        # Cambiar el nombre de la columna "Nombre" a "Cursos"
        df = df.rename(columns={"Nombre": "Cursos"})
        ...
        if "Cursos" in df.columns:
            ...
            st.error("El DataFrame no contiene la columna 'Cursos'.")
